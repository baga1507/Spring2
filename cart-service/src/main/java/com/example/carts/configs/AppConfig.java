package com.example.carts.configs;

import com.example.carts.properties.ProductServiceIntegrationProperties;
    ...
    public WebClient productServiceWebClient() {
        TcpClient tcpClient = TcpClient
                ...
                .doOnConnected(connection -> {
                    ...
                    connection.addHandler(new WriteTimeoutHandler(productServiceIntegrationProperties.getWriteTimeout()));
                });
        return WebClient
                .builder()
